...
from fs_bot.rules_consts import (
    ...
    # Tribes
    TRIBE_MENAPII, TRIBE_MORINI, TRIBE_EBURONES, TRIBE_BELLOVACI, TRIBE_ATREBATES, TRIBE_REMI,
    TRIBE_SUEBI_NORTH, TRIBE_SUGAMBRI, TRIBE_SUEBI_SOUTH, TRIBE_UBII,
    TRIBE_TREVERI,
    TRIBE_SENONES, TRIBE_VENETI, TRIBE_AEDUI,
    TRIBE_ARVERNI, TRIBE_CATUVELLAUNI,
    TRIBE_HELVII,
    TRIBE_NORI,
    # Senate
    INTRIGUE, LEGIONS_ROW_BOTTOM, LEGIONS_ROW_MIDDLE, DISPERSED, DISPERSED_GATHERING,
    # Cards
    WINTER_CARD, CARD_NAMES_ARIOVISTUS, MARKER_BRITANNIA_NOT_IN_PLAY, MARKER_ARVERNI_RALLY,
)
