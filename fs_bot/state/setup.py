...
from fs_bot.rules_consts import (
    ...
    TRIBE_ARVERNI, TRIBE_CADURCI, TRIBE_HELVII,
    TRIBE_NORI,
    # Senate
    INTRIGUE, LEGIONS_ROW_BOTTOM, LEGIONS_ROW_MIDDLE, LEGIONS_ROW_TOP,
    LEGIONS_ROWS, MARKER_BRITANNIA_NOT_IN_PLAY,
    MARKER_ARVERNI_RALLY,
    # Victory
    MAX_RESOURCES,
    # Eligibility
    CARD_NAMES_BASE, CARD_NAMES_ARIOVISTUS,
    WINTER_CARD, ALLIED, DISPERSED, DISPERSED_GATHERING,
)
