...
from fs_bot.rules_consts import (
    ...
    DIVICIACUS, BODUOGNATUS, SCENARIO_PAX_GALLICA, SCENARIO_ARIOVISTUS,
    # Regions
    MORINI, NERVII, ATREBATES, SUGAMBRI, TREVERI, CARNUTES, MANDUBII, AEDUI_REGION, SEQUANI, ARVERNI_REGION,
    BRITANNIA, PROVINCIA, TRIBE_CARNUTES, TRIBE_AULERCI, TRIBE_MANDUBII, TRIBE_AEDUI, TRIBE_TREVERI, TRIBE_SEQUANI, BUILD_COST_PER_FORT, ENTREAT_COST,
    SETTLE_COST,
