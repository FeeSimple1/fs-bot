...
from fs_bot.rules_consts import (
    ...
    LEGION, WARBAND, CITADEL, SETTLEMENT,
    # Piece states
    SCENARIO_PAX_GALLICA, SCENARIO_ARIOVISTUS, MORINI, NERVII, ATREBATES, SUGAMBRI, UBII,
    TREVERI, CARNUTES, MANDUBII, AEDUI_REGION, ARVERNI_REGION,
    PROVINCIA,
    # Tribes
    TRIBE_MENAPII, TRIBE_MORINI, TRIBE_EBURONES, TRIBE_NERVII,
    TRIBE_BELLOVACI, TRIBE_ATREBATES, TRIBE_REMI,
    TRIBE_SUEBI_NORTH, TRIBE_TREVERI, TRIBE_CARNUTES, TRIBE_AULERCI,
