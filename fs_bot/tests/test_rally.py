...
from fs_bot.rules_consts import (
    ...
    # Piece states
    HIDDEN, CAESAR, VERCINGETORIX, SUCCESSOR,
    # Scenarios
    SCENARIO_PAX_GALLICA, SCENARIO_ARIOVISTUS, MORINI, NERVII, ATREBATES, TREVERI, CARNUTES, MANDUBII,
    VENETI, PICTONES, BITURIGES, AEDUI_REGION, SEQUANI,
    ARVERNI_REGION, SUGAMBRI, UBII, PROVINCIA, BELGICA_REGIONS, GERMANIA_REGIONS,
    # Control
    ...
    TRIBE_BELLOVACI, TRIBE_REMI,
    TRIBE_SUEBI_NORTH, TRIBE_SUGAMBRI, TRIBE_TREVERI, TRIBE_CARNUTES, TRIBE_MANDUBII, TRIBE_SENONES, TRIBE_PICTONES, TRIBE_SANTONES,
    TRIBE_AEDUI, TRIBE_ARVERNI, TRIBE_HELVII, MARKER_DEVASTATED, MARKER_INTIMIDATED,
    # Senate
    DISPERSED,
)
from fs_bot.state.state_schema import build_initial_state
from fs_bot.board.pieces import (
    place_piece, count_pieces, get_available,
)
