...
from fs_bot.rules_consts import (
    ...
    INTRIGUE, AUXILIA, WARBAND, ALLY, PROVINCIA, AEDUI_REGION,
    TREVERI, CAPABILITY_CARDS, CAPABILITY_CARDS_ARIOVISTUS,
)
...
from fs_bot.cards.event_eval import (
    ...
    PLACES_AUXILIA, PLACES_WARBANDS, REMOVES_WARBANDS,
    PLACES_ALLIES, PLACES_CITADELS, PLACES_SETTLEMENTS, REMOVES_SETTLEMENTS,
    PLACES_LEADER, REMOVES_LEADER,
    SHIFTS_SENATE,
    REMOVES_RESOURCES,
    FREE_COMMAND, FREE_BATTLE, FREE_MARCH, FREE_RAID, PLACES_MARKERS, REMOVES_MARKERS,
    IS_CAPABILITY,
