...
from fs_bot.rules_consts import (
    ...
    LEADER, LEGION, AUXILIA, WARBAND, FORT, ALLY, CITADEL, HIDDEN, SCENARIO_PAX_GALLICA, SCENARIO_ARIOVISTUS,
    CAESAR, AMBIORIX, MORINI, NERVII, ATREBATES, PROVINCIA, MANDUBII,
    ARVERNI_REGION, CARNUTES, BITURIGES,
    TRIBE_CARNUTES, TRIBE_ARVERNI, EVENT_UNSHADED,
)
