...
from fs_bot.rules_consts import (
    # Factions
    ROMANS, AEDUI, GERMANS,
    # Piece types
    LEADER, LEGION, FORT, ALLY, CITADEL, SETTLEMENT,
    ...
    # Leaders
    DIVICIACUS, MAX_FORTS_PER_REGION, MAX_SETTLEMENTS_PER_REGION,
    # Special
    PROVINCIA, LEGIONS_ROWS, LEGIONS_PER_ROW,
)
